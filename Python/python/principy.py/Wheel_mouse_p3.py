...
while not done:
    ...
    if len(nextByte) == 1:
        ...
        if len(pkt) == 4:  # We got the whole 4 byte packet, start processing it ...
            ...
            ### TODO: Implement X coordinate parsing from the pkt packet, and place the complete 8-bit X value into variable x: ###
            x1 = pkt[1] & 0x3F
            x2 = pkt[0] & 0x03
            ...
            ### TODO: Implement Y coordinate parsing from the pkt packet, and place the complete 8-bit Y value into variable y: ###
            y1 = pkt[2] & 0x3F
            y2 = pkt[0] & 0x0C
            ...
            # Packet[ 40 00 00 00 ]=---, x= 0, y= 0
            # Packet[ 60 00 00 00 ]=L--, x= 0, y= 0
            # Packet[ 70 00 00 00 ]=L-R, x= 0, y= 0
            # Packet[ 60 00 00 00 ]=L--, x= 0, y= 0
            # Packet[ 60 2C 1C 00 ]=L--, x= 44, y= 28
            # Packet[ 45 02 11 00 ]=---, x= 66, y= 81
            # Packet[ 4F 3F 3E 00 ]=---, x= 255, y= 254
